    ...
    componentDidMount() {
       ...
       loginForm.addEventListener('submit', (e) => {
        ...
        e.preventDefault()
           ...
           fireBaseExternalObj.auth.signInWithEmailAndPassword(loginEmail, loginPassword)
       })
       //User sign in method
       ...
       signupForm.addEventListener('submit', (e) => {
           ...
           fireBaseExternalObj.auth.createUserWithEmailAndPassword(signupEmail, signupPassword)
       })
    }
